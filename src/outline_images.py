...
OUTLINE_DATA_DIR = PROJECT_ROOT / "outline_data"

# output directories
NO_OVERLAP_CIRCLE_DIR = OUTLINE_DATA_DIR / "no_overlap_circle"
NO_OVERLAP_CIRCLE_BW_DIR = OUTLINE_DATA_DIR / "no_overlap_circle_bw"
NO_OVERLAP_TRIANGLE_DIR = OUTLINE_DATA_DIR / "no_overlap_triangle"
NO_OVERLAP_TRIANGLE_BW_DIR = OUTLINE_DATA_DIR / "no_overlap_triangle_bw"
OVERLAP_CIRCLE_DIR = OUTLINE_DATA_DIR / "overlap_circle"
OVERLAP_CIRCLE_BW_DIR = OUTLINE_DATA_DIR / "overlap_circle_bw"
OVERLAP_TRIANGLE_DIR = OUTLINE_DATA_DIR / "overlap_triangle"
OVERLAP_TRIANGLE_BW_DIR = OUTLINE_DATA_DIR / "overlap_triangle_bw"
...
def draw_triangle(draw, vertices, color):
    draw.polygon(vertices, outline=color, width=OUTLINE_WIDTH)
...
def generate_dataset(mode):
    ...
    if mode not in mapping:
        print(
            "Usage: python3 outline_images.py [all|no_overlap_circle|no_overlap_circle_bw|"
